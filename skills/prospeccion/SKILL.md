...
**Enrutamiento por presencia web (regla del usuario):**
- **Prospecto CON sitio web** → solo la **infografía de automatización** (no se le hace maqueta web; su web ya existe).
- **Prospecto SIN sitio web** → **maqueta de web (demo-landing) + infografía de automatización**, ambas enlazadas en el mismo correo.
